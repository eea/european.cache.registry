"""add multi year licences

Revision ID: 0043
Revises: 0042
Create Date: 2026-01-22 13:54:51.365918
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("movement_reference_number_id", sa.Integer(), nullable=False),
        sa.Column(
    ...
    with op.batch_alter_table("undertaking", schema=None) as batch_op:
        batch_op.add_column(
