...
def upgrade():
    op.create_table('businessprofile',
                    ...
                    sa.Column('highleveluses', sa.String(length=255),
                              nullable=True),
    ...
    op.create_table('old_company',
                    ...
                    sa.Column('vat_number', sa.String(length=32),
                              nullable=True),
    ...
    op.create_table('represent',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('name', sa.String(length=255), nullable=True),
                    sa.Column('address_id', sa.Integer(), nullable=True),
                    sa.Column('vatnumber', sa.String(length=255),
                              nullable=True),
                    sa.Column('contact_first_name', sa.String(length=255),
                              nullable=True),
                    sa.Column('contact_last_name', sa.String(length=255),
                              nullable=True),
    ...
    op.create_table('undertaking',
                    ...
                    sa.Column('undertaking_type', sa.String(length=32),
                              nullable=True),
                    ...
                    sa.Column('businessprofile_id', sa.Integer(),
                              nullable=True),
                    sa.Column('oldcompany_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['address_id'], ['address.id'], ),
                    sa.ForeignKeyConstraint(['businessprofile_id'],
                                            ['businessprofile.id'], ),
                    sa.ForeignKeyConstraint(['oldcompany_id'],
                                            ['old_company.id'],
                                            name='fk_old_company'),
                    sa.ForeignKeyConstraint(['represent_id'],
                                            ['represent.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('undertaking_users',
